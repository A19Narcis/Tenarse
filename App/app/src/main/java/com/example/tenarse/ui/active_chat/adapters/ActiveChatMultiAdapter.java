            ...
            case TYPE_POST:
                ...
                if (postElement.getPost_image().length() > 0){
                    ...
                    if (postElement.getPost_image().contains(".mp4")){
                        String videoPath = postElement.getPost_image().replace("https://tenarse.online", "http://212.227.40.235");
                        MediaMetadataRetriever retriever = new MediaMetadataRetriever();
                        retriever.setDataSource(videoPath);
                        Bitmap bitmap = retriever.getFrameAtTime(0);
                        postViewHolder.imagePost.setImageBitmap(bitmap);
                    } else {
                        Picasso.with(context).load(postElement.getPost_image().replace("https://tenarse.online", "http://212.227.40.235")).into(postViewHolder.imagePost);
                    }
                } else {
                ...
                Picasso.with(context).load(postElement.getOwner_post_image().replace("https://tenarse.online", "http://212.227.40.235")).into(postViewHolder.postOwnerImage);
            ...
            case TYPE_MY_POST:
                ...
                if (myPostElement.getPost_image().length() > 0){
                    ...
                    if (myPostElement.getPost_image().contains(".mp4")){
                        String videoPath = myPostElement.getPost_image().replace("https://tenarse.online", "http://212.227.40.235");
                        MediaMetadataRetriever retriever = new MediaMetadataRetriever();
                        retriever.setDataSource(videoPath);
                        Bitmap bitmap = retriever.getFrameAtTime(0);
                        mypostViewHolder.imagePost.setImageBitmap(bitmap);
                    } else {
                        Picasso.with(context).load(myPostElement.getPost_image().replace("https://tenarse.online", "http://212.227.40.235")).into(mypostViewHolder.imagePost);
                    }
                } else {
                ...
                Picasso.with(context).load(myPostElement.getOwner_post_image().replace("https://tenarse.online", "http://212.227.40.235")).into(mypostViewHolder.postOwnerImage);
